...
class RPClass(RPClassifier):
    ...
    # [x] add_class                 [x] impl  [x] docstring  [x] unit test  [ ] integration test   (already implemented)
    # [x] add_constructor           [x] impl  [x] docstring  [x] unit test  [ ] integration test   (already implemented)
    # [x] add_destructor            [x] impl  [x] docstring  [x] unit test  [ ] integration test   (already implemented)
    # [x] add_superclass            [x] impl  [x] docstring  [x] unit test  [ ] integration test   (already implemented)
    # [x] get_is_abstract            [x] impl  [x] docstring  [x] unit test  [ ] integration test   (already implemented)
    ...
    # [x] add_type                  [x] impl  [x] docstring  [x] unit test  [ ] integration test
    ...
    # [x] delete_superclass         [x] impl  [x] docstring  [x] unit test  [ ] integration test
    ...
    # [x] set_is_abstract            [x] impl  [x] docstring  [x] unit test  [ ] integration test
